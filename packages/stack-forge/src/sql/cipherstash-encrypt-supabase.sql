...
AS $$
  ...
  BEGIN
    ...
    -- In supabase, the encrypt function (pgcrypto extension) is in the extensions schema.
    -- https://supabase.com/docs/guides/database/extensions
    encrypt_block := extensions.encrypt(data_block::bytea, hash_key::bytea, 'aes-ecb');
